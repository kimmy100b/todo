...
<body>
	...
	<form action="" method="post" class="todo-form">
		<div class="form-group">
			<label>어떤일인가요?</label> <input type="text" placeholder="최대 24자까지"
				maxlength="20" required>
		</div>
		<div class="form-group">
			<label>누가 할일인가요?</label> <input type="text" required>
		</div>
		<span>우선순위를 선택하세요</span>
		<div class="form-radio form-group">
			<input type="radio" id="1" name="sequence" value="1" checked>
			<label for="1">1순위</label><br> <input type="radio" id="2"
				name="sequence" value="2"> <label for="2">2순위</label><br>
